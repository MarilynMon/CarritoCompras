...
namespace PruebaMarilynMonrroy.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = PruebaMarilynMonrroyConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(PruebaMarilynMonrroyDbContext context)
        {
            _context = context;
        }
