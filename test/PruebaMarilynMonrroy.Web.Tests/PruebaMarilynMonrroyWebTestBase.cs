...
{
    public abstract class PruebaMarilynMonrroyWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PruebaMarilynMonrroyWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PruebaMarilynMonrroyWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PruebaMarilynMonrroyDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PruebaMarilynMonrroyDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PruebaMarilynMonrroyDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PruebaMarilynMonrroyDbContext, Task<T>> func)
        {
            T result;
